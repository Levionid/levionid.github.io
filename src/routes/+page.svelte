<script lang="ts">
	...
	const features = [
		...
		{
			title: 'Incendium',
			description: 'Ад, который вы заслужили. Вас ждут 8 новых биомов, 9+ огромных структур вроде Запретного Замка. Это крутейшая доработка Незера, которая заставит вас потеть.',
		...
		{
			title: 'True Ending',
			description: 'Улучшенный эндер дракон, у которого новые атаки, больше здоровья и эпичная финальная фаза.',
			imageUrl: 'true-ending.png',
			alt: 'Битва с улучшенным Эндер Драконом из датапака True Ending'
		},
		{
			title: 'Vanilla Refresh',
			description: 'Более 30 мелких, но приятных QoL-фич. Смотрите на здоровье мобов над хотбаром в подзорной трубе, получайте опыт за сбор урожая, а стойки для брони наконец-то обретут руки!',
